import {
  ...
  APPLYPATCH_ACTION_TYPE,
  FIELDAPI_ACTION_TYPE,
        ...
        items: {
          ...
          patchOperation: {
            ...
            options: function (data) {
              if (
                data.action &&
                (typeof currentEditedAction == "undefined" ||
                  currentEditedAction != data.action)
              )
                currentEditedAction = data.action;
            ...
            change: function (data) {
              if (data.action === FIELDAPI_ACTION_TYPE) {
                ...
                if (typeof params != undefined) data.patchValue = params;
              }
            },
          },
          patchPath: {
  ...
  let dimensions = {
    ...
    items: {
      ...
      labelTxt: {
        ...
        show: function (data) {
          return (
            data.qListObjectDef.qDef.qFieldLabels.length > 0 &&
            data.qListObjectDef.qDef.qFieldLabels[0]
          );
        },
      },
      label: {
      ...
      clearDimension: {
        ...
        show: function (a) {
          return (
            a.qListObjectDef.qLibraryId || a.qListObjectDef.qDef.qFieldDefs[0]
          );
        },
        remove: function (a) {
      ...
      additionalOptions: {
        ...
        items: {
          ...
          itemsLayout: {
            ...
            show: function (data) {
              return !(
                data.renderAs === "select" || data.renderAs === "multiselect"
              );
            },
          },
          hideLabel: {
          ...
          horizontalCenterContent: {
            ...
            label: function (data) {
              return (
                'Center direction "' +
                (data.itemsLayout == "v" ? "Vertical" : "Horizontal") +
                '"'
              );
            },
          ...
          verticalCenterContent: {
            ...
            label: function (data) {
              return (
                'Center direction "' +
                (data.itemsLayout == "h" ? "Vertical" : "Horizontal") +
                '"'
              );
            },
            ref: "centerVertical",
          ...
          spaceEvenly: {
            ...
            show: function (data) {
              return (
                (data.centerVertical || data.centerHorizontal) &&
                (data.renderAs === CHECKBOX_RENDER ||
                  data.renderAs === RADIOBUTTON_RENDERER ||
                  data.renderAs === SWITCH_RENDER)
              );
